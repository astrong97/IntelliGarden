...
public class Controller extends Application {
	...
	static HardwareModule hardware = new HardwareModule();
	Display display = new Display();

	
	
	static BooleanProperty light = new SimpleBooleanProperty(hardware.isLightsOn());
	...
	public void start(Stage primaryStage) throws InterruptedException {
		...
		Scene mainScene = new Scene(display, 1200, 600);
